...
public class PeijianOutActivity extends Activity implements OnClickListener,OnRefreshListener,OnLoadListener,ParserData{
	...
	private void loadData(int what){
		String shop_id = (String) SPUtils.get(PeijianOutActivity.this, SPutilsKey.SHOP_ID, "error");
		String ship_id = (String) SPUtils.get(PeijianOutActivity.this, SPutilsKey.SHIP_ID, "error");
	...
	public void sendResult(String result, int what) {
		System.out.println("配件出库result="+result);
		Log.e("lll", result);
		try {
