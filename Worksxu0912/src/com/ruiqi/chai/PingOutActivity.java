...
public class PingOutActivity extends Activity implements OnClickListener,OnRefreshListener,OnLoadListener,ParserData{
...
//					String dateString = format.format(date);
					...
					String goods_propety = object.getString("goods_propety");//钢瓶类型array(1 => '空瓶', 2 => '重瓶', 3 => '折旧瓶(普通瓶)', 4 => '待修瓶', 5 => '待检瓶', 6 =>'报废瓶')
				
					aList.add(new TableInfo(typename,goods_name, goods_num,time));
				}
			}
