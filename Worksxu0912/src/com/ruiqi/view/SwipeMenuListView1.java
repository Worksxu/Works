 ...
 * 
 */
public class SwipeMenuListView1 extends ListView {
...
//	}
	...
	public SwipeMenuListView1(Context context) {
		super(context);
		init();
	}

	public SwipeMenuListView1(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	public SwipeMenuListView1(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
